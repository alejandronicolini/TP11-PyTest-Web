...
class DatabaseDriver():
    ...
    """
        Class to handle Database drivers. This class not requiered an instance.
        To 'create' a instance, call the method 'getInstance()' that return a Singlenton DatabaseDriver
        for all service requiered.
    """
    ...
    def closeDriver(cls):
        """
            A method that close drivers and set the instance at None.
        """
